...
export declare type Border = boolean | BorderWidth | BorderColor | IBorderElement | IBorder;
...
export declare type BorderColor = Colors | 'white';
export declare type BorderWidth = 0 | 1 | 2 | 3 | 4 | 5 | number;
