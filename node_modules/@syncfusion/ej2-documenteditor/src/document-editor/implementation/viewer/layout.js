...
var Layout = /** @class */ (function () {
    ...
    Layout.prototype.layoutItems = function (sections, isReLayout) {
        ...
        for (var i = 0; i < sections.length; i++) {
            ...
            if (i === 0 || isNullOrUndefined(section.sectionFormat.breakCode) || section.sectionFormat.breakCode === 'NewPage' || height !== section.sectionFormat.pageHeight || width !== section.sectionFormat.pageWidth || (section.sectionFormat.columns.length > 1 || (i - 1 >= 0 && sections[i - 1].sectionFormat.columns.length > 1)) || lastpage.bodyWidgets[lastpage.bodyWidgets.length - 1].lastChild.isEndsWithPageBreak) {
 ...
 */
        ...
        while (count < rowWidgets.length) {
            ...
            if (row.ownerTable.isInsideTable || (this.documentHelper.splittedCellWidgets.length === 0 && tableRowWidget.y + tableRowWidget.height + cellSpacing + this.footnoteHeight <= viewer.clientArea.bottom)) {
                ...
                if (!isNullOrUndefined(splittedWidget) && (isNullOrUndefined(this.documentHelper.owner.editor) || this.documentHelper.owner.editor && !this.documentHelper.owner.editor.isTableInsert) && !(splittedWidget.bodyWidget.containerWidget instanceof FootNoteWidget)) {
                    ...
                    bodyWidget = this.moveBlocksToNextPage(block instanceof ParagraphWidget ? block.previousWidget : keepNext ? block.previousWidget : block, keepNext);
                    ...
                    if (rowToMove.ownerTable.header && tableRowWidget.height < viewer.clientArea.bottom && !keepNext) {
                        ...
                        // let cellspace: number = viewer instanceof PageLayoutViewer ? cellspacing / 2 : cellspacing;
                        var cellspace = cellSpacing / 2;
                        this.updateChildLocationForRow(tableWidget.y - cellspace, splittedWidget, tableWidget.containerWidget);
                    }
    ...
    Layout.prototype.updateChildLocationForRow = function (top, rowWidget, bodyWidget) {
        var spacing = 0;
        if (rowWidget.ownerTable.tableFormat.cellSpacing > 0) {
    ...
    Layout.prototype.updateChildLocationForCellOrShape = function (top, widget, bodyWidget) {
    ...
    Layout.prototype.shiftLayoutedItems = function (reLayout) {
        ...
        var splittedWidget = block.getSplitWidgets();
        var nextBlock = splittedWidget[splittedWidget.length - 1].nextRenderedWidget;
        while (nextBlock instanceof BlockWidget && (nextBlock.bodyWidget.index === sectionIndex || (nextBlock.bodyWidget.sectionFormat.breakCode === 'NoBreak' && ((nextBlock.bodyWidget.nextRenderedWidget !== undefined && nextBlock.bodyWidget.nextRenderedWidget.page === nextBlock.bodyWidget.page) || nextBlock.bodyWidget.nextRenderedWidget === undefined)))) {
            var currentWidget = undefined;
            var blocks = block.getSplitWidgets();
            currentWidget = blocks[blocks.length - 1];
            block = nextBlock;
