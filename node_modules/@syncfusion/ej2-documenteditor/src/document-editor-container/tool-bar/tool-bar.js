...
var Toolbar = /** @class */ (function () {
            ...
            if (this.toolbarItems.indexOf('Break') >= 0) {
                this.breakDropDwn = new DropDownButton({
                    items: [
                        ...
                        { text: locale.getConstant('Column Break'), iconCss: 'e-icons e-de-ctnr-page-break-column', id: id_1 + COLUMN_BREAK }
                    ],
    ...
    Toolbar.prototype.onFileChange = function () {
        ...
        if (file) {
            var formatType = file.name.substr(file.name.lastIndexOf('.'));
            if (formatType === '.sfdt') {
